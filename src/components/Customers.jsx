        ...
        <div className="bg-gray-100 rounded-lg shadow shadow-slate-600 overflow-scroll ">
          ...
          <div className="xs:max-xl:bg-white bg-red-40 px-5 py-3 flex justify-between items-center font-bold text-slate-600 text-sm xs:max-xl:mt-40">
            ...
            <div className="bg-red-20 w-[16%]">
              <p className="border-r border-slate-400 px-5 ">CUSTOMERS</p>
            </div>
            <div className="bg-red-20 w-[16%] ">
              <p className="border-r border-slate-400 px-5 ">PHONE</p>
            </div>
            <div className="bg-red-20 w-[16%]">
              <p className="border-r border-slate-400 px-5 ">EMAIL</p>
            </div>
            <div className="bg-red-20 w-[20%]">
              <p className="border-r border-slate-400 px-5 ">ADDRESS</p>
            </div>
            <div className="bg-red-20 w-[16%]">
              <p className="border-r border-slate-400 px-5 ">TOTAL DEBT</p>
            </div>
            <div className="bg-red-20 w-[10%]">
              <p className="border-r border-slate-400 px-5 ">ACTIONS</p>
            </div>
          </div>
