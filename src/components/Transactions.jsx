    ...
    navRes.transaction === "" ? (
      ...
      <div>
        <div className="bg-blue-40 absolute top-0 left-0 h-full w-full overflow-scroll z-50 p-3 xs:max-xl:p-0">
          ...
          {/* ol */}
          <div className="bg-gray-500 rounded-lg shadow shadow-slate-600 overflow-scroll  xs:max-xl:w-full ">
            ...
            <div className="flex justify-between my-5 px-5">
              ...
              <div className="flex gap-5">
                ...
                <div> 
                  <button className="p-2 w-40  xs:max-xl:w-28 rounded-md text-slate-200 font-normal bg-transparent border border-purple-900 text-lg flex justify-between items-center">
            ...
            <div className=" bg-red-400 px-5 py-3 flex justify-between items-center font-bold text-slate-600 text-sm bg-red-40">
              <div>
                <input type="checkbox" />
              </div>
              <div className="bg-red-200 w-[14%]  xs:max-xl:min-w-[8rem]">
                <p className="border-r border-slate-400 px-5 ">#ID</p>
              </div>
              <div className="bg-red-200 w-[20%]  xs:max-xl:min-w-[8rem]">
              ...
              <div className="bg-red-200 w-[10%]  xs:max-xl:min-w-[8rem]">
                <p className="border-r border-slate-400 px-5 ">
                  TOTAL
                </p>
              </div>
              <div className="bg-red-200 w-[15%]  xs:max-xl:min-w-[8rem]">
                <p className="border-r border-slate-400 px-5 ">
                  DATE
                </p>
              </div>
              <div className="bg-red-200 w-[12%]  xs:max-xl:min-w-[8rem]">
                <p className="border-r border-slate-400 px-5 ">
                  STATUS
                </p>
              </div>
              ...
              {navRes.transaction.map((items, index) => {
                return (
                  <div key={items.invoiceId} className="border-b-[1px] border-slate-300 px-5 py-2 flex justify-between items-center font-bold text-slate-600 text-sm bg-red-40">
                    ...
                    <div className="bg-red-20 w-[20%]  xs:max-xl:min-w-[8rem] flex items-center pl-3">
                    ...
                    <div className="bg-red-20 w-[15%]  xs:max-xl:min-w-[8rem] ml-3 pl-2">
