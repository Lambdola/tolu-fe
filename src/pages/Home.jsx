      ...
      <div className="pt-32 bg-red-70">
        <div className="px-4">
          ...
          <div className="font-light text-base mt-5">
            ...
            <p>
              No more unaccounted sales and unsolicited payments. Watch where
              and how your money moves by tracking issued invoices.
            </p>
          </div>
        </div>
        ...
        <div className="px-4 xl:w-2/3">
          <div className="w-full h-52 bg-slate-200 rounded-lg">
            <img
              src={business_people}
        ...
        <div className="my-10 px-4">
          <p className="font-light text-base">
            Receive money linked to an invoice from anywhere and with any means
          </p>
          ...
          <div className="space-y-7">
            ...
            <div className="bg-[#2F2F2F] p-5 rounded-2xl space-y-3">
              ...
              <p className="text-slate-400 font-light text-sm leading-7">
                ...
                invoices. With user-friendly templates and customizable options,
                you can effortlessly create professional invoices tailored to
                your business needs. Streamline your billing process and get
                paid faster with our service.
              </p>
            </div>
            <div className="bg-[#2F2F2F] p-5 rounded-2xl space-y-3">
              <p className="font-semibold text-white">
              ...
              <p className="text-slate-400 font-light text-sm leading-7">
                ...
                status. Monitor payments effortlessly, ensuring transparency and
                timely follow-ups. Stay organized and informed, empowering you
                to manage finances efficiently and maintain strong client
                relationships.
              </p>
            </div>
          </div>
        ...
        <div className="w-[90%] mx-auto my-10 space-y-3 rounded-xl p-5 bg-zinc-950 xl:w-1/3">
          ...
          <div className="bg-red-30 my-10">
            <button  onClick={() => navigate("/log-in")} className="hover:bg-orange-500 bg-slate-50 p-3 rounded-md text-black hover:text-white font-semibold">
              Get started
            </button>
          </div>
        </div>
